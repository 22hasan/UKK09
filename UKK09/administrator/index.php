    ...
    <div class="row">
      <div class="col">
        <div class="card" style="width: 10rem;">
          <img src="../barang.png" class="card-img-top" alt="..." height="170px" width="300px">
          <div class="card-body">
            <p class="card-text">
      ...
      <div class="col">
        <div class="card" style="width: 10rem ;">
          <img src="../pembeli.jpg" class="card-img-top" alt="..." height="145px" width="500px">
          <div class="card-body">
            <p class="card-text">
              <button type="button" class="btn btn-primary">
      ...
      <div class="col">
        <div class="card" style="width: 10rem;">
          <img src="../pelanggan.jpg" class="card-img-top" alt="..." height="145px" width="300px">
          <div class="card-body">
            <p class="card-text">
              <button type="button" class="btn btn-primary">
